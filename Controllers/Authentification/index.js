...
const sendemail = async (name,email, otpCode)=>{
       ...
       let mailOptions ={
        ...
        to:email,
        subject:"Demande d'activation de votre compte sur l'  application ControlerPower recu",
        html:`Cher(e) <b style="font-size:1.2em; color:#227ABD;">${name}</b>, nous avons recu votre demande d'activation de compte chez ControlerPower. <p> Votre code est: <b style="font-size:1.5em; color:#ff6c00">${otpCode} </b></p> <p>ce code doit rester prive</p>`,
    };
    ...
    .then((datas)=> {
        ...
        res.json({message: "'success': New User created"});
            ...
            let mailOptions ={
                ...
                subject:"Creation de compte reussi, Bienvenu sur la plaforme de gestion efficace des ligne MT",
                text:`Cher(e) ${DatasOfForm.fname} ${DatasOfForm.lname},Bienvenue chez ControlPower.`,
            };
